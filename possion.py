...
def helper_text():
    ...
    print("\nExample:\n\tpython possion.py 0 20 12 0 10 6.5 -> Setting default vals for <discrete_event_steps> and <lambda_steps>\n\tpython possion.py 0 20 12 0 10 6.5 1 -> Setting val for <discrete_event_steps> but not <lambda_steps>\n\tpython possion.py 0 20 12 0 10 6.5 1 0.5 -> Setting vals for both <discrete_event_steps> and <lambda_steps>")
